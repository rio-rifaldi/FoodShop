...
import { RedisClusterOptions } from '@redis/client/dist/lib/cluster/index';
import { RedisCommandArgument, RedisFunctions, RedisModules, RedisScripts } from '@redis/client/dist/lib/commands/index';
